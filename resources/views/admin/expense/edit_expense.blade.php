                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
								...
								@endif
                                <form  method="post" action="{{url('/admin/edit_expense/'.$expense_details->id)}}" novalidate>
                                	@csrf
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Date <span class="text-danger">( Required )</span></label>
                                        <div class="col-sm-10">
                                            <input id="dropper-default" name="entry_date" id="entry_date" class="form-control" type="text" value="{{$expense_details->entry_date}}"/>
                                            ...
                                            <select name="expense_category_id" id="expense_category_id" class="js-example-basic-single col-sm-12">
                                                <option disabled="">Select expense category</option>
                                                    @foreach($categories as $category)
                                                        @if($category->id == $expense_details->expense_category_id)
                                                           <option value="{{$category->id}}" selected="">{{$category->expense_category_title}}</option>
                                                        @else
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="expense" id="expense" value="{{$expense_details->expense}}">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="checkbox-fade fade-in-primary">
                                                <label>
                                                    <input type="checkbox" id="status" name="status" @if($expense_details->status=="Active") checked @endif value="1">
                                                    <span class="cr">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <button type="submit" value="Update expense" class="btn btn-primary m-b-0">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
